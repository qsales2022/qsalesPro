...
const useGetHomeSectionsTwo = () => {
  const { language = "EN" } = useSelector(
    (state: RootState) => state.AuthReducer
  );
  const [sectionListSecond, setSectionList] = useState<any>(null);
  ...
  metaobject(id: $id) {
    fields {
      value
          ...
          variables: {
            id: "gid://shopify/Metaobject/15876522273",
          },
        });
  ...
  return { sectionListSecond, loading, error };
};

export default useGetHomeSectionsTwo;
